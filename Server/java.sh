...
echo " [+] Downloading the .deb files "
  case `dpkg --print-architecture` in
	aarch64)
		archname="aarch64"; jre="aarch64" ;;
	arm64)
		archname="aarch64"; jre="aarch64" ;;
	armhf)
		archname="arm"; jre="arm" ;;
	armv7l)
		archname="arm"; jre="arm" ;;
	arm)
		archname="arm"; jre="arm" ;;
   ...
   wget -c --quiet --show-progress "https://archive.org/download/openjdk-9-jre-headless_9.2017.8.20-1_x86_64/openjdk-9-jre-headless_9.2017.8.20-1_$jre.deb" -O $jre
